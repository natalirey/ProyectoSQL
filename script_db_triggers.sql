...
FOR EACH ROW
BEGIN
    INSERT INTO MIEMBROS_LOG (OPERACION, NOMBRE_MIEMBRO, DNI_MIEMBRO, FECHA_OPERACION, USUARIO_OPERACION)
    VALUES ('INSERT', NEW.NOMBRE_MIEMBRO, NEW.DNI_MIEMBRO, NOW(), CURRENT_USER());
END;
//
DELIMITER ;
...
-- Este trigger registra la operación antes de modificar un pago.
DELIMITER //
...
-- Este trigger registra la operación después de modificar un registro en la tabla de pagos 
-- Trigger que registra la operación después de modificar un registro en la tabla de pagos
...
-- Actualizo un registro en la tabla de pagos
 UPDATE PAGOS SET MONTO = 25000.00 WHERE ID_MIEMBRO = 1;
...
VALUES ('12','Miley Cyrus', '12345678', '1992-11-23', 'soyhannahmontana@email.com', '1122334455', '1122334456', 'si', '2023-12-01');
